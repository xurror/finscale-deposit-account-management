...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("depositAccountManagement")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "depositAccountManagement"
        ...
        config.mapConfigs["org.muellners.finscale.deposit.domain.*"] = initializeDomainMapConfig(jHipsterProperties)
