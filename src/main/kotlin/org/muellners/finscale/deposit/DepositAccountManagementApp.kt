...
import org.muellners.finscale.deposit.client.OAuth2InterceptedFeignConfiguration
import org.muellners.finscale.deposit.config.ApplicationProperties
...
class DepositAccountManagementApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes depositAccountManagement.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<DepositAccountManagementApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(DepositAccountManagementApp::class.java)
