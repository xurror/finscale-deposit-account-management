package org.muellners.finscale.deposit.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(org.muellners.finscale.deposit.repository..*)" +
            " || within(org.muellners.finscale.deposit.service..*)" +
            " || within(org.muellners.finscale.deposit.web.rest..*)"
    )
